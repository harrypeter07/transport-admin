      ...
      <div className="bg-white border border-[#e8e8e8] rounded-xl shadow-xs overflow-hidden">
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="tel" className="w-full rounded-lg border border-[#e8e8e8] bg-[#f7f7f7] px-3.5 py-2.5 text-sm text-[#1c1b1f]" placeholder="+91 00000 00000" />
              </div>
              <div>
                <label className="block text-xs font-bold text-[#6b6b6b] uppercase tracking-widest mb-1.5">Email Address</label>
                <input type="email" className="w-full rounded-lg border border-[#e8e8e8] bg-[#f7f7f7] px-3.5 py-2.5 text-sm text-[#1c1b1f]" placeholder="user@corporate.com" />
              </div>
            </div>
            <div>
              <label className="block text-xs font-bold text-[#6b6b6b] uppercase tracking-widest mb-1.5">Residential Address</label>
              <textarea className="w-full rounded-lg border border-[#e8e8e8] bg-[#f7f7f7] px-3.5 py-2.5 text-sm text-[#1c1b1f]" rows={3}></textarea>
            </div>
            <button type="button" className="px-4 py-2 bg-[#1c1b1f] text-white text-sm font-bold rounded-lg hover:bg-black transition-colors">
              Save Changes
            </button>
          </form>
        </div>
        ...
        <div className="p-6 bg-[#f7f7f7]">
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="/change-password" className="px-4 py-2 border border-[#d0d0d0] text-[#4a4a4a] text-sm font-bold rounded-lg hover:bg-[#f7f7f7] transition-colors bg-white">
              Update Password
            </a>
          </div>
        </div>
