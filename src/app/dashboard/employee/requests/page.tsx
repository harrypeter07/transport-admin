...
export default function EmployeeRequestsPage() {
 ...
 className={`px-4 py-2 border rounded-none text-xs font-bold transition cursor-pointer flex items-center gap-1.5 ${
 activeForm === "LEAVE"
 ...
 {message && (
 <div className={`p-4 rounded-none border text-xs font-semibold flex items-center gap-2 animate-fadeIn ${
 message.isError ? "bg-[#f7f7f7] text-[#1c1b1f] border-[#e8e8e8]" : "bg-[#f7f7f7] text-[#1c1b1f] border-[#e8e8e8]"
 }`}>
 <AlertCircle size={16} />
 {message.text}
 </div>
 ...
 {activeForm === "LEAVE" && (
 <form onSubmit={handleLeaveSubmit} className="bg-white border border-[#e8e8e8] rounded-none p-6 shadow-xs animate-fadeIn space-y-4 max-w-xl">
 ...
 className="w-full bg-white border border-[#e8e8e8] rounded-none text-sm p-2 px-3 focus:outline-none focus:border-slate-350"
 />
 </div>
 <div>
 ...
 className="w-full bg-white border border-[#e8e8e8] rounded-none text-sm p-2 px-3 h-20 focus:outline-none focus:border-slate-350"
 />
 </div>
 ...
 className="px-4 py-2 border border-[#e8e8e8] text-[#6b6b6b] rounded-none text-xs font-bold hover:bg-[#f7f7f7] transition cursor-pointer"
 >
 Cancel
 </button>
 <button
 type="submit"
 disabled={submitting}
 className="px-4 py-2 bg-[#1c1b1f] text-white rounded-none text-xs font-bold hover:bg-black transition cursor-pointer disabled:opacity-50"
 >
 ...
 {activeForm === "TIMING" && (
 <form onSubmit={handleTimingSubmit} className="bg-white border border-[#e8e8e8] rounded-none p-6 shadow-xs animate-fadeIn space-y-4 max-w-xl">
 <h2 className="text-sm font-black text-[#4a4a4a] uppercase tracking-widest border-b border-slate-100 pb-2 flex items-center gap-2">
 <Clock3 size={16} className="text-[#6b6b6b]" /> Request Timing Change
 </h2>
 {employee?.shift && (
 <div className="bg-[#f7f7f7] border border-slate-150 rounded-none p-3 text-xs text-[#6b6b6b]">
 ...
 className="w-full bg-white border border-[#e8e8e8] rounded-none text-sm p-2 px-3 focus:outline-none focus:border-slate-350 cursor-pointer"
 >
 ...
 <td className="p-3">
 <span className={`inline-flex items-center px-2 py-0.5 rounded-none text-[10px] font-black uppercase tracking-wider ${
 l.status === 'APPROVED' ? 'bg-[#f7f7f7] text-[#1c1b1f]' :
 l.status === 'REJECTED' ? 'bg-[#f7f7f7] text-[#1c1b1f]' :
 ...
 <td className="p-3">
 <span className={`inline-flex items-center px-2 py-0.5 rounded-none text-[10px] font-black uppercase tracking-wider ${
 t.status === 'APPROVED' ? 'bg-[#f7f7f7] text-[#1c1b1f]' :
 t.status === 'REJECTED' ? 'bg-[#f7f7f7] text-[#1c1b1f]' :
