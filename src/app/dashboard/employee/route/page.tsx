...
export default function EmployeeRoutePage() {
 ...
 {/* Status Card */}
 <div className="md:col-span-2 bg-white border border-[#e8e8e8] rounded-none shadow-xs overflow-hidden flex flex-col">
 ...
 isInProgress ? 'bg-[#f7f7f7] text-[#1c1b1f]' : 'bg-[#f7f7f7] text-[#4a4a4a]'
 }`}>
 ...
 <div className="w-full bg-slate-200 rounded-none h-2.5 mb-2 overflow-hidden flex">
