...
function Toast({ msg, type }: { msg: string; type: "success" | "error" }) {
  return (
    <div
      className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5 rounded-none shadow-sm text-sm font-bold border animate-fadeIn ${type === "success"
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-[#f7f7f7] rounded-none border border-slate-100">
            ...
            <button
              ...
              className={`relative w-11 h-6 rounded-none transition-colors ${settings.leaveApprovalRequired ? "bg-[#1c1b1f]" : "bg-slate-300"
                }`}
            >
              <span
                className={`absolute top-1 left-1 w-4 h-4 rounded-none bg-white shadow transition-transform ${settings.leaveApprovalRequired ? "translate-x-5" : "translate-x-0"
                  }`}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-[#f7f7f7] rounded-none border border-slate-100">
            ...
            <button
              ...
              className={`relative w-11 h-6 rounded-none transition-colors ${settings.timingChangeApprovalRequired ? "bg-[#1c1b1f]" : "bg-slate-300"
                }`}
            >
              <span
                className={`absolute top-1 left-1 w-4 h-4 rounded-none bg-white shadow transition-transform ${settings.timingChangeApprovalRequired ? "translate-x-5" : "translate-x-0"
                  }`}
              />
            </button>
          </div>
