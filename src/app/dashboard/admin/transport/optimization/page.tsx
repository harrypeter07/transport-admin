...
export default function TransitAdminSPA() {
 ...
 placeholder="Search..."
 className="bg-white border border-[#e8e8e8] rounded-none text-xs py-2 px-3 focus:outline-none focus:border-[#d0d0d0] w-64"
 />
 </div>
 ...
 {/* Employees Table */}
 <div className="lg:col-span-8 p-5 rounded-none bg-white border border-[#e8e8e8] shadow-xs flex flex-col gap-4">
 ...
 <div className="overflow-x-auto border border-slate-100 rounded-none max-h-[460px] overflow-y-auto">
 <table className="w-full text-left text-xs border-collapse">
 <thead>
 <tr className="bg-[#f7f7f7] border-b border-[#e8e8e8] text-[#9a9a9a] font-mono text-[9px] uppercase tracking-wider">
 ...
 className="p-1.5 bg-[#f7f7f7] border border-[#e8e8e8] rounded-none text-[#1c1b1f] hover:bg-[#f7f7f7] transition"
 >
 ...
 {/* Excel import */}
 <div className="p-5 rounded-none bg-white border border-[#e8e8e8] shadow-xs flex flex-col gap-4">
 <h2 className="text-xs font-bold text-[#1c1b1f] uppercase tracking-wider flex items-center gap-2">
 ...
 className="w-full flex items-center justify-center gap-1.5 bg-black text-white py-2 rounded-none text-xs font-bold hover:bg-slate-850 transition disabled:opacity-50 cursor-pointer"
 >
 {uploading ? "Importing..." : "Import & Auto-Optimize"}
 </button>
 </form>
 ) : (
 <div className="p-3 bg-[#f7f7f7] border border-amber-150 text-[10px] rounded-none text-[#1c1b1f] leading-normal text-left">
 ...
 <div className="flex flex-col items-center justify-center p-3 border border-dashed border-[#e8e8e8] bg-[#f7f7f7] rounded-none hover:border-slate-350 transition cursor-pointer relative group">
 <input
 type="file"
 id="fileInput"
 accept=".xlsx, .xls, .csv"
 ...
 className="w-full flex items-center justify-center gap-1.5 bg-[#f7f7f7] border border-[#e8e8e8] hover:bg-[#f7f7f7] text-[#4a4a4a] py-1.5 rounded-none text-xs font-bold transition disabled:opacity-50 cursor-pointer"
 >
 Upload File
 </button>
 </form>
 ...
 disabled={uploading}
 className="w-full flex items-center justify-center gap-1.5 bg-[#f7f7f7] border border-[#e8e8e8] hover:bg-red-105 hover:border-[#e8e8e8] text-[#1c1b1f] py-1.5 rounded-none text-xs font-bold transition disabled:opacity-50 cursor-pointer"
 >
 <RefreshCw className="w-3.5 h-3.5" />
 ...
 className="flex items-center gap-1 text-[9px] text-[#ff4f00] hover:text-[#1c1b1f] font-bold self-start border-b border-transparent hover:border-[#1c1b1f] pb-0.5 transition"
 >
 ...
 {uploadMsg && (
 <div className="p-3 bg-[#f7f7f7] border border-[#e8e8e8] text-[10px] rounded-none text-[#6b6b6b] flex items-start gap-1.5 text-left animate-fadeIn">
 ...
 placeholder="EMP201"
 className="bg-white border border-[#e8e8e8] rounded-none text-xs py-2 px-3 focus:outline-none focus:border-[#d0d0d0]"
 />
 </div>
 ...
 <button
 type="submit"
 className="col-span-2 mt-2 bg-[#1c1b1f] text-white py-2 rounded-none text-xs font-bold hover:bg-black transition"
 >
 Register Employee
 </button>
 {employeeFormError && (
 <div className="col-span-2 p-2.5 bg-[#f7f7f7] border border-[#e8e8e8] rounded-none text-[10px] text-[#1c1b1f] font-semibold animate-fadeIn">
 {employeeFormError}
 </div>
 )}
 </form>
 ...
 {/* Cab Manual Add */}
 <div className="lg:col-span-4 p-5 rounded-none bg-white border border-[#e8e8e8] shadow-xs flex flex-col gap-4">
 <h2 className="text-xs font-bold text-[#1c1b1f] uppercase tracking-wider flex items-center gap-2">
 <Plus className="w-4 h-4 text-[#6b6b6b]" />
 Register Cab & Driver
 </h2>
