...
export default function ForgotPasswordPage() {
 ...
 <div className="inline-flex items-center justify-center w-12 h-12 rounded-none bg-[#f7f7f7] text-[#1c1b1f] mb-2">
 ...
 <Link href="/login" className="block w-full py-2.5 text-sm font-bold text-[#1c1b1f] border border-[#e8e8e8] rounded-none hover:bg-[#f7f7f7] transition-all mt-4">
 Return to Login
 </Link>
 </div>
 ) : (
 ...
 <div
 role="alert"
 className="flex items-start gap-2.5 rounded-none border border-[#e8e8e8] bg-[#f7f7f7] px-3.5 py-2.5"
 >
