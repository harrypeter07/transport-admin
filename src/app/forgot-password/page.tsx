        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-xs p-7">
          {state?.success ? (
            <div className="text-center space-y-4">
              ...
              <Link href="/login" className="block w-full py-2.5 text-sm font-bold text-slate-900 border border-slate-200 rounded-lg hover:bg-slate-50 transition-all mt-4">
                Return to Login
              </Link>
            </div>
          ) : (
