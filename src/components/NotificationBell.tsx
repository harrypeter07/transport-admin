...
export default function NotificationBell() {
 ...
 className="relative p-2 text-[#6b6b6b] hover:text-[#1c1b1f] hover:bg-[#f7f7f7] rounded-none transition-colors focus:outline-none"
 >
 <Bell size={18} />
 {unreadCount > 0 && (
 ...
 {showDropdown && (
 <div className="absolute right-0 mt-2 w-80 bg-white border border-[#e8e8e8] shadow-xl rounded-none overflow-hidden z-50">
