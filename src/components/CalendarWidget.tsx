...
export default function CalendarWidget() {
  ...
  return (
    <div className="bg-white border border-[#e8e8e8] rounded-xl p-6 shadow-xs flex flex-col h-full">
      ...
      {loading ? (
        <div className="flex-grow flex items-center justify-center py-10">
          <div className="w-6 h-6 rounded-full border-2 border-[#e8e8e8] border-t-slate-800 animate-spin-fast"></div>
        </div>
      ) : (
        <div className="flex flex-col gap-4">
          <div className="bg-[#f7f7f7] border border-[#e8e8e8] rounded-lg p-4">
